...
public class TeleOperated extends SequoiaOpMode {
    ...
    public void runTriggers() {
        ...
        gamepad1H.rightBumperButton().onPress(new InstantTask( () -> {carousel.pause();}));
        gamepad1H.leftBumperButton().onPress(new InstantTask( () -> carousel.red()));
        gamepad1H.yButton().onPress(new InstantTask( () -> carousel.blue()));
...
//
        ...
        gamepad2H.lteftButton().onPress(new InstantTask( () -> {arm.setMode(SwingArmS.ArmState.LEFT);}));
